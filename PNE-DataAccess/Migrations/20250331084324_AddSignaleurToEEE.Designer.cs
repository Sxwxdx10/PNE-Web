...
namespace PNE_DataAccess.Migrations
{
    ...
    [Migration("20250331084324_AddSignaleurToEEE")]
    partial class AddSignaleurToEEE
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PNE_core.Models.EEE", b =>
                {
                    ...
                    b.HasIndex("IdSignaleur");

                    b.ToTable("EEEEs", (string)null);
                });
            ...
            modelBuilder.Entity("PNE_core.Models.EEEPlanEau", b =>
                {
                    ...
                    b.HasKey("IdEEE", "IdPlanEau");

                    b.HasIndex("IdPlanEau");

                    b.ToTable("EEEPlanEau", (string)null);
                });
            ...
            modelBuilder.Entity("PNE_core.Models.EEE", b =>
                {
                    b.HasOne("PNE_core.Models.Utilisateur", "Signaleur")
                        .WithMany()
                        .HasForeignKey("IdSignaleur")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
